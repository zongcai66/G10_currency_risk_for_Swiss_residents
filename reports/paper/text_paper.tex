...
A study on the foreign exchange market and international trade~\cite{AUBOIN_RUTA_2013} indicates that the volatility of the exchange rate not only increases the uncertainties for exporters and importers, but also impacts cross-border investments. Companies facing sharp exchange rate fluctuations may experience revenue shrinkage due to foreign currency depreciation, or even suffer asset devaluation. Moreover, persistent exchange rate changes can reshape strategic decisions of multinational corporations regarding investment locations and capital allocation~\cite{riker2020review}.
