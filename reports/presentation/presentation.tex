...
% ---------------------------------------------------------------------------
\begin{frame}
\centering \LARGE \textbf{Literature Review}
...
\begin{itemize}
    ...
    \item Data for G10 currencies (except Switzerland and Sweden) countries were obtained from the Federal Reserve Economic Data (FRED) database~\cite{fred}.
    \item Data for Switzerland was retrieved from the Swiss National Bank's (SNB) official API~\cite{snb}.
    \item Data for Sweden was sourced from the Swedish Riksbank’s Interest Rates and Exchange Rates Statistics~\cite{riksbank}.
\end{itemize}
\end{frame}
% ---------------------------------------------------------------------------
\begin{frame}
