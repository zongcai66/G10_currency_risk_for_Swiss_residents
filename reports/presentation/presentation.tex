...
% \begin{figure}[h]
%     \centering  \includegraphics[width=0.9\linewidth]{../../reports/figures/monte_carlo_price_simulation_GBPCHF_vs_CHF.png}
...
% NZD has considerable volatility in the actual market, then there may be other factors significantly affect NZD, e.g. commodity price fluctuations (as New Zealand is a major commodity exporter~\cite{blundell1990exchange}) and speculative behavior in the foreign exchange market.
% \end{frame}
% ---------------------------------------------------------------------------
\begin{frame}
\section{Conclusion}
