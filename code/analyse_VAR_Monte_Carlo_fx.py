...
df = pd.read_csv("https://raw.githubusercontent.com/zongcai66/G10_currency_risk_for_Swiss_residents/refs/heads/main/data/modeling_data/yahoo_FX_2.csv", header=None, names=['Date', 'Currency Pair', 'Type', 'Value'])
